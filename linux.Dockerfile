...
RUN echo $'<Counter-Strike 1.6>\n' && \
    for i in 10 70; do wget -P /output/steamapps -q https://raw.githubusercontent.com/LacledesLAN/HLDS-appmanifest/main/CounterStrike/appmanifest_$i.acf -O appmanifest_$i.acf; done && \
...
RUN echo $'<Counter-Strike: Condition Zero>\n' && \
    for i in 10 70 80 90; do wget -P /output/steamapps -q https://raw.githubusercontent.com/LacledesLAN/HLDS-appmanifest/main/CounterStrikeConditionZero/appmanifest_$i.acf -O appmanifest_$i.acf; done && \
...
RUN echo $'<Day of Defeat>\n' && \
    for i in 10 30 70 90; do wget -P /output/steamapps -q https://raw.githubusercontent.com/LacledesLAN/HLDS-appmanifest/main/DayOfDefeat/appmanifest_$i.acf -O appmanifest_$i.acf; done && \
...
RUN echo $'<Deathmatch Classic>\n' && \
    for i in 10 40 70 90; do wget -P /output/steamapps -q https://raw.githubusercontent.com/LacledesLAN/HLDS-appmanifest/main/DeathmatchClassic/appmanifest_$i.acf -O appmanifest_$i.acf; done && \
...
RUN echo $'<Half-Life: Deathmatch>\n' && \
    for i in 10 70 90; do wget -P /output/steamapps -q https://raw.githubusercontent.com/LacledesLAN/HLDS-appmanifest/main/HalfLifeDeathmatch/appmanifest_$i.acf -O appmanifest_$i.acf; done && \
...
RUN echo $'<Opposing Force>\n' && \
    for i in 10 50 70 90; do wget -P /output/steamapps -q https://raw.githubusercontent.com/LacledesLAN/HLDS-appmanifest/main/OpposingForce/appmanifest_$i.acf -O appmanifest_$i.acf; done && \
...
RUN echo $'<Ricochet>\n' && \
    for i in 10 60 70 90; do wget -P /output/steamapps -q https://raw.githubusercontent.com/LacledesLAN/HLDS-appmanifest/main/Ricochet/appmanifest_$i.acf -O appmanifest_$i.acf; done && \
...
RUN echo $'<Team Fortress Classic>\n' && \
    for n in 1 2; do \
        for i in 10 20 70 90; do \
            wget -P /output/steamapps -q https://raw.githubusercontent.com/LacledesLAN/HLDS-appmanifest/main/TeamFortressClassic/appmanifest_$i.acf -O appmanifest_$i.acf; \
        done; \
